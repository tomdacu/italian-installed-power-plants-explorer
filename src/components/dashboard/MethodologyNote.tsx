    ...
    <section className="card p-5">
      ...
      <div className="mt-2 space-y-1.5 text-xs leading-relaxed text-ink-500 dark:text-ink-400">
        ...
        <p>
          ...
          <strong className="font-semibold">Generation plants</strong> (bioenergy exists only in{" "}
          <em>Renewable source capacity</em>). They differ on hydro:{" "}
          <em>Renewable source capacity</em> excludes pure pumped storage
